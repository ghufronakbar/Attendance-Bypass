...
const DropDownWeek = ({
  ...
  return (
    <div className="relative inline-block text-left">
      ...
      <div
        className={`w-full max-h-40 overflow-y-auto hide-scroll absolute right-0 z-10 mt-2 origin-top-right bg-white focus:outline-none shadow-[3px_3px_0px_rgba(0,0,0,1)] active:shadow-[2px_2px_0px_rgba(0,0,0,1)] border-black border-2 divide-y divide-black ${
          open ? "" : "hidden"
        }`}
        role="menu"
